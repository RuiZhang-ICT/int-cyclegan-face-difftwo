...
class UnalignedFromlistDataset(BaseDataset):
    ...
    def initialize(self, opt):
       ...
       # rui add start
        ...
        self.A_paths = self.collect_img_from_list(self.list_A)
        self.B_paths = self.collect_img_from_list(self.list_B)

        print('training set A:', len(self.A_paths))
        print('training set B:', len(self.B_paths))
